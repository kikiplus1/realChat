...
export class ChatPage extends Component {
    ...
    componentDidMount() {
        ...
        this.props.dispatch(getChats()); // 리덕스에 dispatch하기

        this.socket = io(server);


        this.socket.on("connect", messageFromBackEnd => {
    ...
    submitChatMessage = (e) => {
        ...
        this.socket.emit("Input Chat Message", {   //실시간 채팅을 위해 소켓 사용
            chatMessage,
            userId,
            userName,
            userImage,
